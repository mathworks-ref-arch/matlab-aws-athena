function startup(varargin)
    ...
    if ~isdeployed()
        ...
        iDisplayBanner('MATLAB Interface for AWS Athena');
        ...
        %% Add the interface to the path
        iAddInterfacePath(here);
...
function iAddInterfacePath(rootDir)
    iDisplayBanner('Adding MATLAB interface for AWS Athena Paths');
...
function jarPath = iGetJarPath(rootDir)
    jarPath = fullfile(rootDir,'Software','MATLAB','lib','jar','mathworks-aws-athena-0.2.0-full.jar');
end
